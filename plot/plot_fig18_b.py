...
def plot_normalized_latency(
    ...
    plt.plot(BLOCK_SIZES, latencies, marker='o', markersize=4, linewidth=1, color='tab:blue')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_dir', type=str, default='./results/alpaca/opt-13b-tp1/n1/cacheflow/')
    parser.add_argument('--req', type=float, default=30.1)
