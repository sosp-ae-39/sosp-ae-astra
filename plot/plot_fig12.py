...
# These request rates are used with different block sizes
# in other experiments (Fig 18-b and Fig 19-b).
SKIP_REQUEST_RATES = [2.01, 30.1]
...
def plot_normalized_latency(
    ...
    for save_dir in save_dirs:
        ...
        if request_rate in SKIP_REQUEST_RATES:
            continue
